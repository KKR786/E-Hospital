  ...
  return (
    <div className="px-4 py-10 bg-gray-50">
      ...
      {userData && (
        ...
        <label htmlFor="street" className="absolute top-[-13px] left-3 bg-gray-50">
          Street Address
        </label>
        <input
          className="block w-full p-2 ps-3 text-sm text-gray-900 border-[2.5px] border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none"
      ...
      <div className="relative w-[20%]">
        <label htmlFor="city" className="absolute top-[-13px] left-3 bg-gray-50">
          City
        </label>
        <input
          className="block w-full p-2 ps-3 text-sm text-gray-900 border-[2.5px] border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none"
      ...
      <div className="relative w-[20%]">
        <label htmlFor="zip" className="absolute top-[-13px] left-3 bg-gray-50">
          Zip Code
        </label>
        <input
          className="block w-full p-2 ps-3 text-sm text-gray-900 border-[2.5px] border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none"
      ...
      <div className="relative w-[25%]">
        <label htmlFor="country" className="absolute top-[-13px] left-3 bg-gray-50">
          Country
        </label>
        <input
          className="block w-full p-2 ps-3 text-sm text-gray-900 border-[2.5px] border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 focus:outline-none"
